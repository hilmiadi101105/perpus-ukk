            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <a href="/"
                        <span class="app-brand-text demo menu-text fw-bold ms-2 href="/" ">HAFauzan</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item ">
                        <a href="{{ route('dashboard') }}" class="menu-link">
                            <class="menu-link">
                            <div data-i18n="Dashboards"><i class="fa-solid fa-house"></i>   Dashboards</div>
                           
                        </a>
                    <li class="menu-item ">
                        <a href="{{ route('kategori') }}" class="menu-link">
                            <div data-i18n="Analytics"><i class="fa-solid fa-layer-group"></i> Data Kategori</div>
                            <div class="badge bg-label-primary fs-tiny rounded-pill ms-auto">Pro</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('buku.index') }}" class="menu-link">
                            <div data-i18n="eCommerce"><i class="fa-solid fa-book"></i>    Data Buku</div>
                            <div class="badge bg-label-primary fs-tiny rounded-pill ms-auto">Pro</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item">
                      <a href="{{ route('peminjaman.index') }}" class="menu-link">
                          <div data-i18n="eCommerce"><i class="fa-solid fa-book-open-reader"></i>   Data Peminjaman</div>
                          <div class="badge bg-label-primary fs-tiny rounded-pill ms-auto">Pro</div>
                      </a>
                  </li>
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span class="fw-medium d-block">Hilmi Adi Fauzan</span>
